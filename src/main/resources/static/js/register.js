    ...
    function putIn() {
        ...
        var register_success_img = $('<div class="register_success_img">\n' +
            '            <img src="https://javatiaozaowang.obs.myhuaweicloud.com:443/UserHead/successbeijing.png" class="am-img-thumbnail">\n' +
            '        </div>');
        sec.append(register_success_img);

        var register_success_words = $('<div class="register_success_words">\n' +
            '            <img src="https://javatiaozaowang.obs.cn-east-3.myhuaweicloud.com:443/UserHead/zhucesuccess.jpg">\n' +
            '            <p>恭喜注册成功，快去登录吧</p>\n' +
            '        </div>');
