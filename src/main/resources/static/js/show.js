    ...
    function putInArticle(data) {
        $('.tiaozaowang-article-top').html('');
        $('.tiaozaowang-article-footer').html('');
        var articleTop = $('<article-top><div class="article-title">' +
            ...
            '关注求职、跳槽领域，专注java技术分享，java面试经验、java面试总结及面试资料，零基础培训，一对一培训。<span class="article-i-say-me">--- IT枫斗者</span>' +
            '</div>');
        $('.tiaozaowang-article-top').append(articleTop);
        ...
        var articleFooter = $('<div class="end-logo">' +
            ...
            '<img src="static/img/blogImag/wx.jpg">' +
            '</p>' +
            '<p class="show-weixin-pic">欢迎关注我的微信公众号：IT枫斗者</p>' +
            ...
            '</span>' +
            '</div>');
        $('.tiaozaowang-article-footer').append(articleFooter);
    ...
    $.ajax({
        ...
        success:function (data) {
            if(data['status'] == 0){
                ...
                $('.content').html('');
                var error = $('<div class="article"><div class="tiaozaowang-article-top"><div class="error">' +
                    '<img src="https://javatiaozaowang.obs.cn-east-3.myhuaweicloud.com:443/UserHead/register_success.jpg">' +
                    '<p>没有找到这篇文章哦</p>' +
                    '<p>可能不小心被博主手残删掉了吧</p>' +
                    '<div class="row">' +
                    '<a href="/">返回首页</a>' +
