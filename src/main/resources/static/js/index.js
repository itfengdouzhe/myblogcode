    ...
    //网站最后更新时间（版本更新需更改）
    var siteLastUpdateTime = '2020年7月23日21点';

    //网站开始时间
    var siteBeginRunningTime = '2021-05-20 13:14:00';
    ...
    $('.myCardBtn').click(function () {
        $('.qq_code').attr("src","/img/blogImag/qq.png");
        $('.weixin_code').attr("src","/img/blogImag/qq.png");
    });
